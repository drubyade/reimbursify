                      ...
                      <div className="flex-1 p-2 md:p-2.5 flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-2.5 bg-white">
                        ...
                        <div className="flex items-center gap-2.5 flex-[1.5] min-w-0 w-full">
                          ...
                          <div className="min-w-0 flex-1 flex flex-col gap-0.5">
                            <h3 className="font-bold text-base text-gray-900 truncate flex items-center gap-2" title={group.name}>
                              {group.name}
                              {group.isCollaborator && (
                                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[var(--primary)] text-white uppercase tracking-wider">
                                  Collaborator
                                </span>
                              )}
                            </h3>
                    ...
                    <div className="p-4 pt-5 flex flex-col border-b border-gray-100 bg-gray-50/30">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-bold text-lg text-gray-900 truncate mb-1 flex items-center gap-2" title={group.name}>
                            {group.name}
                            {group.isCollaborator && (
                              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[var(--primary)] text-white uppercase tracking-wider">
                                Collaborator
